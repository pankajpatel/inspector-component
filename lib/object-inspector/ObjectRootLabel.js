...
let ObjectRootLabel = /*#__PURE__*/function (_HTMLElement) {
  _inherits(ObjectRootLabel, _HTMLElement);
  var _super = _createSuper(ObjectRootLabel);
  ...
  _createClass(ObjectRootLabel, [{
    ...
    value: function connectedCallback() {
      ...
      this.innerHTML = name && typeof name === "string" ? "<span>\n          <object-name name='".concat(name, "'></object-name>\n          <span>: </span>\n          <object-preview data='").concat(this._data, "' ></object-preview>\n        </span>") : "<object-preview data='".concat(this._data, "' ></object-preview>");
    }
  }]);
