...
let ObjectLabel = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(ObjectLabel, [{
    ...
    value: function connectedCallback() {
      ...
      this.themeStyles = (0, _createStyles.default)("ObjectName", this.theme);
    ...
    value: function render() {
      ...
      let appliedStyles = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.appliedStyles;
      this.innerHTML = "<span style='".concat((0, _inlineToStyle.default)(appliedStyles), "'>").concat(name, "</span>");
    }
  }]);
  return ObjectLabel;
