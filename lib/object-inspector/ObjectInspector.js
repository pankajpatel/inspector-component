...
const template = scope => "\n<tree-view\n  theme='".concat(scope.theme, "'\n  data='").concat(scope.data, "'\n  show-non-enumerable='").concat(scope.showNonenumerable, "'\n  sort-object-keys='").concat(scope.sortObjectKeys, "'\n></tree-view>\n");
let ObjectInspector = /*#__PURE__*/function (_HTMLElement) {
  _inherits(ObjectInspector, _HTMLElement);
  var _super = _createSuper(ObjectInspector);
