...
let Inspector = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(Inspector, [{
    ...
    value: function log(_data) {
      ...
      if (data !== this._data) {
        this._data = data;
        (0, _dom.$prepend)(this.inspector(data), this.dom);
      } else {
    ...
    value: function inspector(data) {
      return data && data.length ? template({
        data
      }) : "";
    }
  }, {
    ...
    value: function render(data) {
      this._data = data;
      this.dom.innerHTML = "".concat((0, _index.default)(), "\n    ").concat(this.inspector(data));
    }
  }]);
  return Inspector;
